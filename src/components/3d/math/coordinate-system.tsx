...
function AnimatedPoint({
  ...
  return (
    <mesh ref={meshRef} position={[2, 1, 1]}>
      ...
      <meshStandardMaterial color={colors.destructive.light} emissive={colors.destructive.light} emissiveIntensity={0.3} />
    </mesh>
  );
}
    ...
    <group>
      ...
      {showGrid && (
        <Grid
          ...
          cellSize={1}
          cellThickness={0.5}
          cellColor={colors.three.textMuted}
          sectionSize={size}
          sectionThickness={1}
          sectionColor={colors.neutral[400]}
          fadeDistance={size * 2}
          position={[0, 0, 0]}
      ...
      {/* Axes */}
      <AxisArrow direction={[1, 0, 0]} color={colors.three.axisX} label="X" size={size} showLabel={showLabels} />
      <AxisArrow direction={[0, 1, 0]} color={colors.three.axisY} label="Y" size={size} showLabel={showLabels} />
      <AxisArrow direction={[0, 0, 1]} color={colors.three.axisZ} label="Z" size={size} showLabel={showLabels} />
